...
const btnBase = cn(
  "group relative inline-flex h-11 min-w-[10rem] items-center justify-center gap-2 rounded-xl px-6",
...
export function HeroActions() {
  ...
  return (
    <motion.div
      className="mt-8 flex w-full max-w-sm flex-col items-stretch gap-3 sm:max-w-none sm:flex-row sm:flex-wrap sm:items-center sm:justify-center"
      initial="hidden"
      animate="show"
      variants={{
        hidden: {},
      ...
      >
        <Link
          ...
          className={cn(
            ...
            "hover:bg-[#0958a8] hover:shadow-[0_4px_14px_-4px_rgba(10,102,194,0.4)]",
          )}
        >
          <LinkedInSvg />
          LinkedIn
      ...
      >
        <Link
          ...
          className={cn(
            ...
            "hover:bg-[#25253c] hover:shadow-[0_4px_14px_-4px_rgba(0,0,0,0.28)]",
